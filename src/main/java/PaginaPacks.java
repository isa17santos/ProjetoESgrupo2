...
public class PaginaPacks {
    ...
    private JLabel packsLabel = new JLabel("Packs");
    ...
    private void configurarComponentes() {
        ...
        packsLabel.setForeground(corFundoLabel);
        packsLabel.setBackground(corFundo);
        packsLabel.setFont(new Font("Georgia", Font.PLAIN, 70));
        packsLabel.setOpaque(true);
        // --------------------- PACKS LABEL -----------------------
        ...
        mainPanel.add(packsLabel, "x 570, y 200");
    ...
    private void adicionarProdutos(List<Produto> produtos) {
        ...
        for (Produto produto : produtos) {
            ...
            addBtn.addActionListener(e -> {
                ...
                bd.gravarDados();
                app.mostrarPaginaPacks(); // refresh (opcional)
            });
