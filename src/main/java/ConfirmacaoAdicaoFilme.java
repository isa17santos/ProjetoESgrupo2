...
public class ConfirmacaoAdicaoFilme {
    ...
    private JLabel filmeAdicionarLabel;
    ...
    private void configurarComponentes() {
        ...
        filmeAdicionarLabel.setHorizontalAlignment(SwingConstants.CENTER);
        filmeAdicionarLabel.setForeground(corFundoLabel);
        filmeAdicionarLabel.setBackground(corFundo);
        filmeAdicionarLabel.setFont(new Font("Georgia", Font.PLAIN, 80));
        filmeAdicionarLabel.setOpaque(true);
        // --------------------- FILME ADICIONAR LABEL -----------------------
        ...
        mainPanel.add(filmeAdicionarLabel, "x 450, y 110");
