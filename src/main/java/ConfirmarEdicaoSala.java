...
public class ConfirmarEdicaoSala {
    ...
    // Construtor
    public ConfirmarEdicaoSala(AppWindow app, String nomeSala) {
        this.app = app;
        confirmacaoLabel.setText("<html>" + nomeSala + " editada" + "<br>com sucesso!</html>");
