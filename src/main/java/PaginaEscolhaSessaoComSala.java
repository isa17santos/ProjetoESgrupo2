...
public class PaginaEscolhaSessaoComSala {
    ...
    private JLabel bilheteiraLabel = new JLabel("Bilheteir");
    ...
    //construtor
    public PaginaEscolhaSessaoComSala(AppWindow app, Filme filme, List<Sala> sala) {
        this.app = app;
        configurarComponentes(filme, sala);
    }

    private void configurarComponentes(Filme filme, List<Sala> sala) {
        ...
        for(Sala s : sala) {
            ...
            System.out.println(s.getDesignacao());
        }
